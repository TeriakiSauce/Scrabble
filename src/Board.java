...
public class Board {
     ...
     */
    public void placeLetter(Hand hand, char letter, int x, int y){
        gameBoard[x][y].setLetter(letter);
        hand.removeLetter(letter);
    }
     ...
     */
    public boolean checkHand(Hand hand, char letter){
        return hand.checkLetter(letter);
    }
